...
new #[Layout('layouts.guest')] class extends Component
{
    ...
    public function login(): void
    {
        ...
        $this->redirectIntended(default: route('chat-list', absolute: false), navigate: true);
    }
}; ?>
...
<div>
    ...
    <form wire:submit="login">
        ...
        <div class="flex justify-center mb-4 space-x-4">
            <a href="/auth/github/redirect" class="inline-flex items-center px-3 py-2 text-sm font-medium leading-4 text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500">
